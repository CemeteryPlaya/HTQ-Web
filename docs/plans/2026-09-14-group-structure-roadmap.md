...
Остальные хвосты сверки (даты в поясе платформы, `UnknownRole`, два давних
падения кадров, переводы экранов прав, обходы сторожа гейтов, устаревшие
комментарии) — закрыты блоком K. Гейт на семь оставшихся аппок и архив
«только чтение» — отдельными спеками.
