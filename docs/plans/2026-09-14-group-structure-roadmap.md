...
|---|---|---|
| Реестр компаний, схемы, `search_path`, claim `company` | ✅ реестр (подпроект 1), HTTP-API и экраны (блок A), короткие адреса `htq/hts/keg/group`, экран выбора компании на голом домене (блок I.2) | архив «только чтение» — **закрыт** ([спека](2026-09-25-archive-read-only-spec.md), [план](2026-09-25-archive-read-only.md)); банкротство с преемником — **закрыто** ([спека](2026-09-26-company-bankruptcy-spec.md), [план](2026-09-26-company-bankruptcy.md)) |
...
Сознательно оставлено — автоматический бэкфилл внешней иерархии по
оргструктуре и прочие границы блока I.2 —
...
Банкротство с преемником — закрыто ([спека](2026-09-26-company-bankruptcy-spec.md), [план](2026-09-26-company-bankruptcy.md)):
переносится только членство, техника, договоры и карточки `hr` остаются в архиве (решение заказчика 26.09).
