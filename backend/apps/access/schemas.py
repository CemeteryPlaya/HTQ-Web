...
class MeRead(BaseModel):
    ...
    # Слаги компаний, чья обслуживающая должность дала часть прав выше
    # (§4.5 расширен задачей 6 блока C, аддитивно). Список, а не одна строка:
    # предки не взаимоисключающи (решение заказчика 7) — роли всех
    # обслуживающих предков складываются, и один слаг лгал бы, когда их
    # больше одного. Отсортирован, пусто у суперпользователя (права ниоткуда
    # не наследуются) и у всех, кому наследование ничего не дало.
