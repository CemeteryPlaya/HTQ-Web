...
class Command(BaseCommand):
    ...
    def handle(self, *args, **opts):
        ...
        # Архивные — тоже: схема архива обязана идти в ногу с кодом, иначе
        # её не прочесть (архив — только чтение) и не восстановить. Сводки
        # собираются только по действующим — rebuild_holding_views сам
        # берёт active_company_slugs.
