"""Функции договорного домена для реестра прав (``apps.access.registry``)."""

FUNCTIONS = (
    ("contracts.budgets", "Бюджеты"),
    ("contracts.budgets.amounts", "Суммы и остатки"),
    ("contracts.counterparties", "Контрагенты"),
    ("contracts.agreements", "Договоры"),
