...
def serialize_completion_act(act: CompletionAct, *, with_budget: bool = False) -> dict:
    ...
    return {
        ...
        "budget_overrun": budget_calc.open_payment_overrun(act) if with_budget else None,
    }
