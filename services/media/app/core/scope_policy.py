...
A `scope` is a high-level classification of the upload context (avatar, chat
attachment, news image, hr document, ...). It drives:
...
The full implementation (mime whitelist, variants, max_mb) is built out in
later phases. This minimal version covers the visibility flag, which is the
