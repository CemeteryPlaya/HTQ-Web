"""Merge new calendar preset keys into existing leveled positions.

Revision ID: 018_merge_calendar_keys
Revises: 017_create_calendar
...
revision = "018_merge_calendar_keys"
down_revision = "017_create_calendar"
branch_labels = None
depends_on = None
