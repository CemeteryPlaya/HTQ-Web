 ...
 * что было раньше. Отклонённый и переделанный объект выглядит по этому
 * полю как обычный черновик, и без списка процессов человек, открывший
 * карточку, не увидит ни того, что его уже отклоняли, ни причины отказа.
 */
