...
export const lazyPages = {
  ...
  ContractsBudgetEdit: React.lazy(() => import('@/pages/contracts/BudgetEdit')),
  ...
  ContractsCounterpartyEdit: React.lazy(() => import('@/pages/contracts/CounterpartyEdit')),
  ...
  ContractsAgreementEdit: React.lazy(() => import('@/pages/contracts/AgreementEdit')),
  ContractsInvoiceList: React.lazy(() => import('@/pages/contracts/InvoiceList')),
  ContractsInvoiceCreate: React.lazy(() => import('@/pages/contracts/InvoiceCreate')),
  ContractsInvoiceDetail: React.lazy(() => import('@/pages/contracts/InvoiceDetail')),
  ContractsInvoiceEdit: React.lazy(() => import('@/pages/contracts/InvoiceEdit')),
  ...
  ContractsAccountableFundsRequestList: React.lazy(() => import('@/pages/contracts/AccountableFundsRequestList')),
  ContractsAccountableFundsRequestCreate: React.lazy(() => import('@/pages/contracts/AccountableFundsRequestCreate')),
  ContractsAccountableFundsRequestDetail: React.lazy(() => import('@/pages/contracts/AccountableFundsRequestDetail')),
  ...
  ContractsCompletionActList: React.lazy(() => import('@/pages/contracts/CompletionActList')),
  ContractsCompletionActCreate: React.lazy(() => import('@/pages/contracts/CompletionActCreate')),
  ContractsCompletionActDetail: React.lazy(() => import('@/pages/contracts/CompletionActDetail')),
  ContractsGoodsInvoiceList: React.lazy(() => import('@/pages/contracts/GoodsInvoiceList')),
  ContractsGoodsInvoiceCreate: React.lazy(() => import('@/pages/contracts/GoodsInvoiceCreate')),
  ContractsGoodsInvoiceDetail: React.lazy(() => import('@/pages/contracts/GoodsInvoiceDetail')),
